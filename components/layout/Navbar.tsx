    ...
    <>
      <nav className="fixed top-6 left-6 right-6 z-110 flex justify-between items-center pointer-events-none">
        ...
        <div className="flex items-center gap-2 md:gap-3 pointer-events-auto">
          {/* Search Bar */}
          <div className="hidden lg:flex items-center bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl px-4 py-2 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] border border-white/40 dark:border-white/5 min-w-[360px] focus-within:ring-2 ring-primary/20 transition-all">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-2xl w-10 h-10 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md shadow-md border border-white/20 dark:border-zinc-800/50 hover:bg-white dark:hover:bg-zinc-900 transition-all"
            onClick={() =>
