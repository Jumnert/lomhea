      ...
      <div className="z-10 w-full max-w-6xl">
        ...
        <div className="bg-white dark:bg-zinc-900 overflow-hidden rounded-[40px] shadow-2xl border border-zinc-200 dark:border-zinc-800">
          <div className="grid min-h-[700px] lg:grid-cols-2">
            ...
            <div className="relative m-4 rounded-3xl bg-[url('https://images.unsplash.com/photo-1544256718-3bcf237f3974?q=80&w=1200')] bg-cover bg-center p-12 text-white overflow-hidden">
